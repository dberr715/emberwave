const VisionMission = () => {
  return (
    <div className="container mx-auto px-6 sm:px-12 lg:px-20 py-16 space-y-16">
      {/* Vision Statement */}
      <div className="w-full bg-dark/70 text-white text-center py-12 px-6 sm:px-12 lg:px-20">
      ...
      <div className="flex flex-wrap justify-center items-center gap-16">
        ...
        <div className="flex flex-col items-center">
          <h3 className="text-highlight text-xl md:text-2xl font-bold mb-4">
            AI Integration
          </h3>
          {/* Icon Attribution: Machine learning icons created by Irvan Kurnianto - Flaticon */}
          <div className="w-72 h-72 mask mask-hexagon bg-highlight/70 p-8 flex items-center justify-center shadow-orangeGlow transition-transform transform hover:scale-105 hover:shadow-orangeGlow-lg">
            <img
